...
{
  "is_ai_related": true/false,     // 是否与 AI 相关。广义判断——除了人工智能、机器学习、大模型、自动化等技术话题外，以下也算 AI 相关：AI 公司（OpenAI、Google DeepMind、Anthropic、Meta AI 等）及其创始人/高管的任何新闻（包括个人丑闻、诉讼、争议、八卦）；AI 产品引发的社会事件或用户纠纷；AI 相关的政策、监管、伦理争议
  "is_story": true/false,          // 是否值得读者关注。以下情况应为 true：新模型/产品发布、研究报告、重大政策、行业事件、有影响力的人物观点、AI 行业人物的争议/丑闻/诉讼/八卦、AI 产品导致的用户事故或社会事件、有话题性和讨论热度的事件。以下情况为 false：招聘广告、纯财报数据、无实质内容的简短公告
